...
export default function WexTitle({workExp}: { workExp: WorkExp }) {
    return <div className="flex flex-row items-center justify-between ">
        ...
        {workExp.employer && <>
            <div className="text-xl text-center text-gray-600 dark:text-gray-400 mx-4">•</div>
            <div className="text-md text-left text-gray-600 dark:text-gray-400">{workExp.employer}</div>
        </>}
    </div>;
}